<<<<<<< HEAD
# Multimodal-Rag-Capstone<br>

Agents code is in services/Query_services.py which is integrated with tools.
...
Hybrid Search<br>
=======
1.Use the below for db creation:
...
2. Ingest once more to save the image paths to the data folder
>>>>>>> raghul
